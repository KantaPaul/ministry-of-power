...
import { useEnergyDivisionOfficeNews } from "@framework/energy-division-news";
export { getStaticProps } from "@framework/ssr/office.energy.index.ssr";
  ...
  return (
    <>
      ...
      <div className="pb-[120px] pt-[90px]">
        <div className="content_body">
          <NewsCard news={energyNews} meta="office" />
          {/* @ts-ignore */}
